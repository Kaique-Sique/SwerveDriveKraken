...
public final class Constants {
  ...
  public static final class SubsystemsConstants {
    ...
    public static final class LiftConstants {
      ...
      public static final double KS = 0; // 0.25;//<-MNL 11/11/2024 0.1; //0.32; // Add 0.1 V output to overcome static
                                         // friction
      public static final double KV = 6.8364;// 0.12; //1.51; // A velocity target of 1 rps results in 0.12 V output
      public static final double KA = 0.0;// 0.01; //0.27;

      // TO DO: This must be tuned to specific robot
      public static final double kP = 53.773;// 50//35// 0.0665;//ANTERIOR 0,0665 ; 0.05872615 // kP = 0.11 An error of
                                             // 1 rps results in 0.11 V output
      public static final double kI = 0.0;
      public static final double kD = 8.6157;

      public static final double KS1 = 0.45817;// 0.25;//<-MNL 11/11/2024 0.1; //0.32; // Add 0.1 V output to overcome
                                               // static friction
      public static final double KV1 = 5.8956;// 0.12; //1.51; // A velocity target of 1 rps results in 0.12 V output
      public static final double KA1 = 0.0;// 0.01; //0.27;
      public static final double kP1 = 48.429;
      public static final double kI1 = 0.0;
      public static final double kD1 = 13.049;

      public static final double KG = 0.34714;
      public static final double KG1 = 0.3834;
       ...
       * 
       * //Lift Encoder
       * public static final double kLiftPositionConversionFactor = kLiftGearRatio*
       * Math.PI * kLiftPulleyRatio * kLiftTuboDiam; // rotation to meters
       * public static final double kLiftVelocityConversionFactor =
       * kLiftPositionConversionFactor/60; //meters/sec (2 * Math.PI) / 60.0; //
       * radians per second
       * //Lift PID
       * public static final double kPLiftUp = 1.0;//ANTERIOR 0,25 ; 0.2142875; 0.175;
       * 0.125; 0.23
       * public static final double kILiftUp = 0;
       * public static final double kDLiftUp = 0;
       * public static final double kLiftUpFF = 0; // = input = 0 to position control
       * and 1.0/473.0 to velocity control
       * public static final double kLiftMinOutput = -1;
       * public static final double kLiftMaxOutput = 1;
       * 
       * public static final double kPLiftDown = 0.5;//ANTERIOR 0,25 ; 0.2142875;
       * 0.175; 0.125; 0.23
       * public static final double kILiftDown = 0;
       * public static final double kDLiftDown = 0;
       * public static final double kLiftDownFF = 0; // = input = 0 to position
       * control and 1.0/473.0 to velocity control
       * 
       * //Lift Soft Limits
      ...
      public static final double l1Setpoint = 0.20; // l1SetpointClear/LiftConstants.kLiftGearRatio;
      public static final double l2Setpoint = 0.45; // l2SetpointClear/LiftConstants.kLiftGearRatio;
      public static final double l3Setpoint = 0.85; // l3SetpointClear/LiftConstants.kLiftGearRatio;
      public static final double l4Setpoint = 1.48;// 1.45 //l4SetpointClear/LiftConstants.kLiftGearRatio;
    }
    ...
    public static final class CoralIntakeConstants {
      ...
      public static final double KS = 0.1;// <-MNL 11/11/2024 0.1; //0.32; // Add 0.1 V output to overcome static
                                          // friction
      ...
      // TO DO: This must be tuned to specific robot
      public static final double kP = 2.0;// <--MNL11/11/2024 0.0665;//ANTERIOR 0,0665 ; 0.05872615 // kP = 0.11 An
                                          // error of 1 rps results in 0.11 V output
      public static final double kI = 0.0;
    ...
    public static final class AlgaIntakeConstants {
      ...
      public static final double kAlgaPositionConversionFactor = Math.PI * kGearRatio * kPulleyRatio * kWheelDiameter;// rotation
                                                                                                                      // to
                                                                                                                      // Meters
    ...
    public static final class ArticuladorAlgaeConstants {
      ...
      // TO DO: This must be tuned to specific robot
      public static final double kArticuladorAlgaePositionConversionFactor = 360 * kGearRatio * kPulleyRatio; // rotation
                                                                                                              // to
                                                                                                              // graus
      public static final double kArticuladorAlgaeVelocityConversionFactor = kArticuladorAlgaePositionConversionFactor
          / 60.0; // rotation to m/s

      // ArticuladorAlgae PID Up
      public static final double kPslot0 = 0.02;// ANTERIOR 0,25 ; 0.2142875; 0.175; 0.125; 0.23
    ...
    public static final class ArticuladorCoralConstants {
      ...
      public static final double kArticuladorCoralPositionConversionFactor = Math.PI * kGearRatio * kPulleyRatio * 100; // rotation
                                                                                                                        // to
                                                                                                                        // graus
      public static final double kArticuladorCoralVelocityConversionFactor = kArticuladorCoralPositionConversionFactor
          / 60.0; // rotation to m/s

      // ArticuladorCoral PID Up
      public static final double kPslot0 = 0.3;// ANTERIOR 0,25 ; 0.2142875; 0.175; 0.125; 0.23
      public static final double kIslot0 = 0.05;
      public static final double kDslot0 = 0;
      public static final double kFFslot0 = 0; // = input = 0 to position control and 1.0/473.0 to velocity control
      ...
      public static final double kPslot1 = 0.08;// 0.15//ANTERIOR 0,25 ; 0.2142875; 0.175; 0.125; 0.23
      public static final double kIslot1 = 0;
      public static final double kDslot1 = 0.015;
      public static final double kFFslot1 = 0; // = input = 0 to position control and 1.0/473.0 to velocity control
    ...
    public static final class RampConstants {
      ...
      public static final double kRampVelocityConversionFactor = kRampPositionConversionFactor / 60.0; // rotation to
                                                                                                       // m/s

      // Ramp PID Up
      public static final double kPslot0 = 0.1;// ANTERIOR 0,25 ; 0.2142875; 0.175; 0.125; 0.23
      public static final double kIslot0 = 0;
      public static final double kDslot0 = 0;
      public static final double kFFslot0 = 0; // = input = 0 to position control and 1.0/473.0 to velocity control
      public static final double kMinOutputslot0 = -1;
      ...
      // Ramp PID Down
      public static final double kPslot1 = 1.1;// ANTERIOR 0,25 ; 0.2142875; 0.175; 0.125; 0.23
      public static final double kIslot1 = 0;
      public static final double kDslot1 = 0.8;
      public static final double kFFslot1 = 0; // = input = 0 to position control and 1.0/473.0 to velocity control
    ...
    public static final class EscaladorConstants {
      ...
      /*
       * public static final double KS = 0.1;//<-MNL 11/11/2024 0.1; //0.32; // Add
       * 0.1 V output to overcome static friction
       * public static final double KV = 0.12; //1.51; // A velocity target of 1 rps
       * results in 0.12 V output
       * public static final double KA = 0.11; //0.27;
       * 
       * //TO DO: This must be tuned to specific robot
       * public static final double kP = 0.0665;//<--MNL11/11/2024 0.0665;//ANTERIOR
       * 0,0665 ; 0.05872615 // kP = 0.11 An error of 1 rps results in 0.11 V output
       * public static final double kI =0.0;
       * public static final double kD=0.0;
       * 
       * public static final double kFF = 1.0/6000.0;
  ...
  public static final class Pose2dConstansts {
    ...
    public static final class RedsPose2d {
      public static final Pose2d coralA = new Pose2d(new Translation2d(14.8, 4.10),
          Rotation2d.fromDegrees(180));

      public static final Pose2d driverStation = new Pose2d(new Translation2d(16.2, 6.5),
          Rotation2d.fromDegrees(-125));

      public static final Pose2d startPosition = new Pose2d(new Translation2d(16,4.1),
          Rotation2d.fromDegrees(180));
    }

    // Poses to alliance blue
    public static final class BluePose2d {
      public static final Pose2d coralA = new Pose2d(new Translation2d(2.7, 3.8),
          Rotation2d.fromDegrees(0));

      public static final Pose2d driverStation = new Pose2d(new Translation2d(14.8, 4.1),
          Rotation2d.fromDegrees(180));
    }
  }
}
